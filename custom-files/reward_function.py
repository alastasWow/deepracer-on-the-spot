...
class RewardV3:
    ...
    def regularStep(self,params):
        ...
        if (not self.manageOut(params)):
            ...
            #Attibruate reward
            return self.manageRewardForProgression775(params,currentProgress)
        else:
            #Out
            self.lastCurrentProgress=0
            return 1e-3
    ...
    def manageRewardForProgression771(self,params,currentProgress):
        if (currentProgress>0):
            #We made progress
            progress = params['progress']
            #Calculate bonus progression from 4 to 488
    ...
    def manageRewardForProgression772(self,params,currentProgress):
        if (currentProgress>0):
            #We made progress
            progress = params['progress']
            #Calculate bonus progression from 4 to 488
            ...
            if (top<topMax):
                ...
                bonusTop=1+((561-math.exp(top/22))/2)
                #Normal track from 2 to 769
                return (bonusProgress+bonusTop)*currentProgress/2
            else:
                #Too many top from 2 to 489
                return (bonusProgress+1)*currentProgress/2
        else :
            #No progress
            return 1e-3

    def manageRewardForProgression773(self,params,currentProgress):
        if (currentProgress>0):
            #We made progress
            progress = params['progress']
            #Calculate bonus progression from 4 to 488
            ...
            if (top<topMax):
                #We did less than TOP_CONST from to 1 to 281
                bonusTop=1+((561-math.exp(top/22))/1.2)
                #Normal track from 2 to 769
                return (bonusProgress+bonusTop)*currentProgress/1.2
            else:
                #Too many top from 2 to 489
                return (bonusProgress+1)*currentProgress/1.2
        else :
            #No progress
            return 1e-3
    ...
    def manageRewardForProgression775(self,params,currentProgress):
        reward = self.manageRewardForProgression773(params,currentProgress)
        #We add the reward bank factor of 10 top ago
        reward = reward + self.bonusBank10
    ...
    def manageRewardForProgression94(self,params,currentProgress):
        if (currentProgress>0):
            #We made progress
            progress = params['progress']
            #Calculate bonus progression from 301 to 602
    ...
    def manageRewardForProgression95(self,params,currentProgress):
        if (currentProgress>0):
            #We made progress
            progress = params['progress']
            #Calculate bonus progression from 301 to 602
    ...
    def manageRewardForProgression96(self,params,currentProgress):
        if (currentProgress>0):
            #We made progress
            progress = params['progress']
            #Calculate bonus progression from 301 to 602
